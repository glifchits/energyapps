...
Copyright (c) 2013 London Hydro Inc.
Modifications to original style sheet for Ontario Green Button Working Group
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="atom:feed/atom:entry/atom:content/espi:UsagePoint">
						...
						<h1><xsl:text>Usage Information </xsl:text><xsl:call-template name="UsagePoint"/></h1>
							...
							<td>
								<span>
                                    ...
                                    <xsl:for-each select="espi:billingPeriod">
                                        ...
                                        <xsl:text>Usage Period:</xsl:text>
                                        <span>
                                            <xsl:text>&#160;</xsl:text>
                                        </span>
                                        <xsl:for-each select="espi:start">
...
========================================================================== -->
	...
	<xsl:template name="Currency">
		<xsl:choose>
            ...
            <xsl:when test=". = 124"> <!-- Addtion by Affinity Systems: Canadian dollar was missing from the original list of choices -->
                <xsl:text>Canadian Dollar</xsl:text>
            </xsl:when>
            <xsl:when test=". = 978">
